...
less ../../../picrust2_analyses/picrust2_mj_FILTERED/sequences.fna
biom head -i ../../../picrust2_analyses/picrust2_mj_FILTERED/mj_seagrass_selected_taxa/otu_biom_selected_taxa.biom
biom summarize-table -i ../../../picrust2_analyses/picrust2_mj_FILTERED/mj_seagrass_selected_taxa/otu_biom_selected_taxa.biom
...
This is the set of poorly aligned input sequences to be excluded: ASV3909, ASV8025, ASV4090, ASV7809, ASV3523, ASV6036, ASV8053, ASV6871, ASV6950, ASV3676, ASV1697, ASV6593, ASV4125, ASV5862, ASV7629, ASV4998, ASV5629, ASV5172, ASV5234, ASV1552, ASV3223, ASV3624, ASV5055, ASV7153, ASV7946, ASV8047, ASV6478, ASV3882, ASV6782, ASV3696, ASV1149, ASV5876, ASV3705, ASV8026, ASV6474, ASV7947, ASV8174, ASV6929, ASV8109, ASV5181, ASV7566, ASV5989
COMMENT
...
metagenome_pipeline.py -i ../otu_biom_selected_taxa.biom -m marker_predicted_and_nsti.tsv.gz -f EC_predicted.tsv.gz \
                       -o EC_metagenome_out --strat_out
metagenome_pipeline.py -i ../otu_biom_selected_taxa.biom -m marker_predicted_and_nsti.tsv.gz -f KO_predicted.tsv.gz \
